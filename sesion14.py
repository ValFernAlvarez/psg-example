...
# fruta=elegir_fruta()
# print(fruta)
# def devolver_fruta_y_color ():
#     frutas = {'🍅','🍌','🍎','🍇','🍉'}
#     colores = {'🔴','🟠','🟡','🟢','🔵'}
#     return frutas.pop(), colores.pop()
# fruta_aleatoria, color_aleatorio=devolver_fruta_y_color()
# print(fruta_aleatoria, color_aleatorio)
#---
...
# resultado_final=operacion_dos_numeros(20,10,"multiplicacion")
